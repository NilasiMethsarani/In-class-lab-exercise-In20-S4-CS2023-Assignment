...
struct HashTable{
    ...
    string * username = new string[MAX_LENGTH];
    ...
    void insert(string user_name,string user_password){
        ...
        if(empty){
            ...
            cout<<"Hash collision: could not insert user\n";
        }
    }
    ...
    void hash_lookup(string user_name){
        ...
        else if(username[hash] == user_name){
            cout<<"Username: "<<username[hash]<<" Password: "<<password[hash]<<"\n";
        }
        else{
            cout<<"Hash collision: could not find password\n";
        }
    }
